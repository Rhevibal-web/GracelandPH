    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-7 col-sm-12 col-md-12">
                <h4 class="display-4 text-light">My Cart</h4>
                ...
                <table class="table-responsive table bg-light rounded-3">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $fees['tax'] == 'W' ? 'Waived' :  "Php ". $new_amount * .87; ?></td>
                            <td><span class="text-light bg-success fs-6 p-2">
                                    <?php 
                               $total_amount_to_pay = $fees['tax'] == 'W' ? $discount_amt + $shipping_fee :  ($new_amount * .87) + $shipping_fee ;
                                 echo $fees['tax'] == 'W' ? nf2($discount_amt + $shipping_fee) :  nf2(($new_amount * .87) + $shipping_fee) ;
